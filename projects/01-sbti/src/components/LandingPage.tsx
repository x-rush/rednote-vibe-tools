      ...
      <section className="landing-scene" aria-label={`${props.copy.guide.role}${props.copy.guide.name}`}>
        ...
        <div className={`landing-guide${portraitStage === 'css' ? ' landing-guide--fallback' : ''}`}>
          <div className="landing-guide__portrait" aria-hidden="true">
            {portraitStage !== 'css' && <img src={portraitStage === 'master' ? './assets/shbti/guide/guide-master-v1.webp' : './assets/shbti/guide/guide-placeholder-v1.webp'} alt="" width="900" height="1200" decoding="async" onError={() => setPortraitStage((stage) => nextPortraitStage(stage))} />}

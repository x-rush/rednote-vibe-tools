...
const evidenceAssets: Readonly<Record<string, EvidenceAssetSet>> = Object.freeze({
  ...
  'asset-evidence-rest-modern-shape': evidenceAsset('./assets/evidence/rest/asset-evidence-rest-modern-shape-v1.svg'),
  'asset-evidence-take-form': evidenceAsset('./assets/evidence/take/asset-evidence-take-form-v1.svg'),
  'asset-evidence-take-rite': evidenceAsset('./assets/evidence/take/asset-evidence-take-rite-v1.svg'),
  'asset-evidence-take-semantic-change': evidenceAsset('./assets/evidence/take/asset-evidence-take-semantic-change-v1.svg'),
  'asset-evidence-take-moral-fallacy': evidenceAsset('./assets/evidence/take/asset-evidence-take-moral-fallacy-v1.svg'),
  'asset-evidence-pick-form': evidenceAsset('./assets/evidence/pick/asset-evidence-pick-form-v1.svg'),
  'asset-evidence-pick-bian-distinction': evidenceAsset('./assets/evidence/pick/asset-evidence-pick-bian-distinction-v1.svg'),
  'asset-evidence-pick-extensions': evidenceAsset('./assets/evidence/pick/asset-evidence-pick-extensions-v1.svg'),
  'asset-evidence-pick-leaf-story': evidenceAsset('./assets/evidence/pick/asset-evidence-pick-leaf-story-v1.svg'),
  'asset-evidence-watch-form': evidenceAsset('./assets/evidence/watch/asset-evidence-watch-form-v1.svg'),
  'asset-evidence-watch-gloss': evidenceAsset('./assets/evidence/watch/asset-evidence-watch-gloss-v1.svg'),
  'asset-evidence-watch-mirror-relation': evidenceAsset('./assets/evidence/watch/asset-evidence-watch-mirror-relation-v1.svg'),
  'asset-evidence-watch-modern-story': evidenceAsset('./assets/evidence/watch/asset-evidence-watch-modern-story-v1.svg'),
  'asset-evidence-martial-form': evidenceAsset('./assets/evidence/martial/asset-evidence-martial-form-v1.svg'),
  'asset-evidence-martial-shuowen': evidenceAsset('./assets/evidence/martial/asset-evidence-martial-shuowen-v1.svg'),
  'asset-evidence-martial-foot': evidenceAsset('./assets/evidence/martial/asset-evidence-martial-foot-v1.svg'),
  'asset-evidence-martial-value-origin': evidenceAsset('./assets/evidence/martial/asset-evidence-martial-value-origin-v1.svg'),
